...
<body class="sign-in-basic bg-gray-100">
<!-- Navbar Transparent -->

<!-- End Navbar -->
<section>
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11" style="background-image: url('./assets/imagenes/bg7.jpg');">
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    <h1 class="text-white mb-2 mt-6">Bienvenido!</h1>
                    <p class="text-lead text-white">Utilice este formulario para iniciar sesión en su cuenta o crear una nueva.</p>
                </div>
            </div>
        </div>
    </div>
